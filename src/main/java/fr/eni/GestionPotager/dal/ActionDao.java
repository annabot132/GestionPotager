...
public interface ActionDao extends CrudRepository<Action, Integer> {
	...
	List<Action> findActionsByPotagerByIntervalDate(@Param("idPotager") Integer idPotager,
			@Param("dateJour") Date dateJour, @Param("dateJourPlus15") Date dateJourPlus15);
	...
	List<Action> findActionsByPotagerByCarreByIntervalDate(@Param("idCarre") Integer idCarre,
			@Param("idPotager") Integer idPotager, @Param("dateJour") Date dateJour,
			@Param("dateJourPlus15") Date dateJourPlus15);
